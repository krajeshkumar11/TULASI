...
def unfollow(network, arg1, arg2):
    ...
    '''
    # remove the pass below and start writing your code
    # used urls: https://www.w3resource.com/python-exercises/dictionary/
    #python-data-type-dictionary-exercise-12.php
    # used urls: https://www.programiz.com/python-programming/methods/list/remove
    if arg1 in network:
...
def delete_person(network, arg1):
    ...
    if arg1 in network:
        del network[arg1]
    for var_iterable in range(len(network)):
